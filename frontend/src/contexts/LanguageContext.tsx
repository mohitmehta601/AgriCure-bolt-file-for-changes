...
const translations = {
  en: {
    ...
    'dashboard.recommendationHistoryDescription': 'Past recommendations and their application status',
    ...
    'dashboard.startCreatingRecommendations': 'Start by creating your first fertilizer recommendation in the ML Recommendations tab.',
    ...
    'dashboard.temperatureHumidityMoisture': 'Temperature, humidity, and moisture levels',
    'dashboard.completeFormForRecommendations': 'Please complete the enhanced fertilizer form to get detailed recommendations.',
    'dashboard.mlModelPrediction': 'ML Model Prediction',
    'dashboard.aiPoweredRecommendation': 'AI-powered fertilizer recommendation based on your soil and crop data',
    ...
    'dashboard.detailedSoilAnalysis': 'Detailed analysis of your soil conditions',
    ...
    'dashboard.sustainableOptions': 'Sustainable options for long-term soil health improvement',
    ...
    'features.preciseAnalysis.description': 'Get detailed insights into your soil\'s pH, nitrogen, phosphorus, potassium, and moisture levels for accurate recommendations.',
    'features.smartRecommendations.title': 'Smart Fertilizer Recommendations',
    'features.smartRecommendations.description': 'Receive personalized fertilizer suggestions based on your specific soil conditions and crop requirements.',
    'features.yieldTracking.title': 'Yield Tracking',
    'features.yieldTracking.description': 'Monitor your crop performance and track improvements over time with our comprehensive analytics dashboard.',
    'features.mobileDesign.title': 'Mobile-First Design',
    'features.mobileDesign.description': 'Access your farm data anywhere, anytime with our responsive design optimized for mobile devices.',
    'features.expertSupport.title': 'Expert Support',
    'features.expertSupport.description': 'Get guidance from agricultural experts and connect with a community of successful farmers.',
    ...
    'howItWorks.deploySensors.description': 'Install IoT sensors across your fields to monitor soil conditions in real-time.',
    'howItWorks.streamData.title': 'Stream Data to Cloud',
    'howItWorks.streamData.description': 'Sensor data is automatically transmitted to our secure cloud platform for processing.',
    'howItWorks.mlRecommends.title': 'ML Recommends Dosage',
    'howItWorks.mlRecommends.description': 'Our AI analyzes your data and generates precise fertilizer recommendations.',
  ...
  hi: {
    ...
    'dashboard.recommendationHistoryDescription': 'पिछली सिफारिशें और उनकी अनुप्रयोग स्थिति',
    ...
    'dashboard.startCreatingRecommendations': 'एमएल सिफारिश टैब में अपनी पहली उर्वरक सिफारिश बनाकर शुरू करें।',
    ...
    'dashboard.completeFormForRecommendations': 'विस्तृत सिफारिशें प्राप्त करने के लिए कृपया उन्नत उर्वरक फॉर्म पूरा करें।',
    'dashboard.mlModelPrediction': 'एमएल मॉडल भविष्यवाणी',
    'dashboard.aiPoweredRecommendation': 'आपके मिट्टी और फसल डेटा के आधार पर एआई-संचालित उर्वरक सिफारिश',
    ...
    'dashboard.detailedSoilAnalysis': 'आपकी मिट्टी की स्थितियों का विस्तृत विश्लेषण',
    ...
    'dashboard.sustainableOptions': 'दीर्घकालिक मिट्टी स्वास्थ्य सुधार के लिए टिकाऊ विकल्प',
    ...
    'features.preciseAnalysis.description': 'सटीक सिफारिशों के लिए अपनी मिट्टी के pH, नाइट्रोजन, फास्फोरस, पोटैशियम और नमी के स्तर के बारे में विस्तृत जानकारी प्राप्त करें।',
    'features.smartRecommendations.title': 'स्मार्ट उर्वरक सिफारिशें',
    'features.smartRecommendations.description': 'अपनी विशिष्ट मिट्टी की स्थिति और फसल आवश्यकताओं के आधार पर व्यक्तिगत उर्वरक सुझाव प्राप्त करें।',
    'features.yieldTracking.title': 'उपज ट्रैकिंग',
    'features.yieldTracking.description': 'हमारे व्यापक विश्लेषण डैशबोर्ड के साथ अपने फसल प्रदर्शन की निगरानी करें और समय के साथ सुधार को ट्रैक करें।',
    'features.mobileDesign.title': 'मोबाइल-फर्स्ट डिज़ाइन',
    'features.mobileDesign.description': 'मोबाइल उपकरणों के लिए अनुकूलित हमारे रेस्पॉन्सिव डिज़ाइन के साथ कहीं भी, कभी भी अपने खेत के डेटा तक पहुंचें।',
    'features.expertSupport.title': 'विशेषज्ञ समर्थन',
    'features.expertSupport.description': 'कृषि विशेषज्ञों से मार्गदर्शन प्राप्त करें और सफल किसानों के समुदाय से जुड़ें।',
    ...
    'howItWorks.deploySensors.description': 'रीयल-टाइम में मिट्टी की स्थिति की निगरानी के लिए अपने खेतों में IoT सेंसर स्थापित करें।',
    'howItWorks.streamData.title': 'डेटा को क्लाउड में स्ट्रीम करें',
    'howItWorks.streamData.description': 'सेंसर डेटा स्वचालित रूप से प्रसंस्करण के लिए हमारे सुरक्षित क्लाउड प्लेटफॉर्म पर प्रेषित किया जाता है।',
    'howItWorks.mlRecommends.title': 'ML खुराक की सिफारिश करता है',
    'howItWorks.mlRecommends.description': 'हमारा AI आपके डेटा का विश्लेषण करता है और सटीक उर्वरक सिफारिशें उत्पन्न करता है।',
  ...
  pa: {
    ...
    'dashboard.recommendationHistoryDescription': 'ਪਿਛਲੀਆਂ ਸਿਫਾਰਸ਼ਾਂ ਅਤੇ ਉਹਨਾਂ ਦੀ ਐਪਲੀਕੇਸ਼ਨ ਸਥਿਤੀ',
    ...
    'dashboard.startCreatingRecommendations': 'ਐਮਐਲ ਸਿਫਾਰਸ਼ ਟੈਬ ਵਿੱਚ ਆਪਣੀ ਪਹਿਲੀ ਖਾਦ ਸਿਫਾਰਸ਼ ਬਣਾਉਣ ਨਾਲ ਸ਼ੁਰੂ ਕਰੋ।',
    ...
    'dashboard.completeFormForRecommendations': 'ਵਿਸਤ੍ਰਿਤ ਸਿਫਾਰਸ਼ਾਂ ਪ੍ਰਾਪਤ ਕਰਨ ਲਈ ਕਿਰਪਾ ਕਰਕੇ ਉੱਨਤ ਖਾਦ ਫਾਰਮ ਪੂਰਾ ਕਰੋ।',
    'dashboard.mlModelPrediction': 'ਐਮਐਲ ਮਾਡਲ ਭਵਿੱਖਬਾਣੀ',
    'dashboard.aiPoweredRecommendation': 'ਤੁਹਾਡੇ ਮਿੱਟੀ ਅਤੇ ਫਸਲ ਡੇਟਾ ਦੇ ਆਧਾਰ ਤੇ ਏਆਈ-ਸੰਚਾਲਿਤ ਖਾਦ ਸਿਫਾਰਸ਼',
    'dashboard.confidence': 'ਭਰੋਸਾ',
    ...
    'dashboard.detailedSoilAnalysis': 'ਤੁਹਾਡੀਆਂ ਮਿੱਟੀ ਦੀਆਂ ਸਥਿਤੀਆਂ ਦਾ ਵਿਸਤ੍ਰਿਤ ਵਿਸ਼ਲੇਸ਼ਣ',
    ...
    'dashboard.sustainableOptions': 'ਲੰਬੇ ਸਮੇਂ ਦੇ ਮਿੱਟੀ ਸਿਹਤ ਸੁਧਾਰ ਲਈ ਟਿਕਾਊ ਵਿਕਲਪ',
    ...
    'features.preciseAnalysis.description': 'ਸ਼ੁੱਧ ਸਿਫਾਰਸ਼ਾਂ ਲਈ ਆਪਣੀ ਮਿੱਟੀ ਦੇ pH, ਨਾਈਟ੍ਰੋਜਨ, ਫਾਸਫੋਰਸ, ਪੋਟਾਸ਼ੀਅਮ ਅਤੇ ਨਮੀ ਦੇ ਪੱਧਰਾਂ ਬਾਰੇ ਵਿਸਤ੍ਰਿਤ ਜਾਣਕਾਰੀ ਪ੍ਰਾਪਤ ਕਰੋ।',
    'features.smartRecommendations.title': 'ਸਮਾਰਟ ਖਾਦ ਸਿਫਾਰਸ਼ਾਂ',
    'features.smartRecommendations.description': 'ਆਪਣੀਆਂ ਵਿਸ਼ੇਸ਼ ਮਿੱਟੀ ਦੀਆਂ ਸਥਿਤੀਆਂ ਅਤੇ ਫਸਲ ਦੀਆਂ ਲੋੜਾਂ ਦੇ ਆਧਾਰ ਤੇ ਨਿੱਜੀ ਖਾਦ ਸੁਝਾਅ ਪ੍ਰਾਪਤ ਕਰੋ।',
    'features.yieldTracking.title': 'ਫਸਲ ਟਰੈਕਿੰਗ',
    'features.yieldTracking.description': 'ਸਾਡੇ ਵਿਆਪਕ ਵਿਸ਼ਲੇਸ਼ਣ ਡੈਸ਼ਬੋਰਡ ਨਾਲ ਆਪਣੇ ਫਸਲ ਦੇ ਪ੍ਰਦਰਸ਼ਨ ਦੀ ਨਿਗਰਾਨੀ ਕਰੋ ਅਤੇ ਸਮੇਂ ਦੇ ਨਾਲ ਸੁਧਾਰਾਂ ਨੂੰ ਟਰੈਕ ਕਰੋ।',
    'features.mobileDesign.title': 'ਮੋਬਾਇਲ-ਫਰਸਟ ਡਿਜ਼ਾਈਨ',
    'features.mobileDesign.description': 'ਮੋਬਾਇਲ ਡਿਵਾਈਸਾਂ ਲਈ ਅਨੁਕੂਲਿਤ ਸਾਡੇ ਰਿਸਪਾਂਸਿਵ ਡਿਜ਼ਾਈਨ ਨਾਲ ਕਿਤੇ ਵੀ, ਕਦੇ ਵੀ ਆਪਣੇ ਖੇਤ ਦੇ ਡੇਟਾ ਤੱਕ ਪਹੁੰਚ ਕਰੋ।',
    'features.expertSupport.title': 'ਵਿਸ਼ੇਸ਼ਜ ਸਹਾਇਤਾ',
    'features.expertSupport.description': 'ਖੇਤੀਬਾੜੀ ਵਿਸ਼ੇਸ਼ਜਾਂ ਤੋਂ ਮਾਰਗਦਰਸ਼ਨ ਪ੍ਰਾਪਤ ਕਰੋ ਅਤੇ ਸਫਲ ਕਿਸਾਨਾਂ ਦੇ ਭਾਈਚਾਰੇ ਨਾਲ ਜੁੜੋ।',
    ...
    'howItWorks.deploySensors.description': 'ਰੀਅਲ-ਟਾਈਮ ਵਿੱਚ ਮਿੱਟੀ ਦੀਆਂ ਸਥਿਤੀਆਂ ਦੀ ਨਿਗਰਾਨੀ ਲਈ ਆਪਣੇ ਖੇਤਾਂ ਵਿੱਚ IoT ਸੈਂਸਰ ਸਥਾਪਤ ਕਰੋ।',
    'howItWorks.streamData.title': 'ਡੇਟਾ ਨੂੰ ਕਲਾਊਡ ਵਿੱਚ ਸਟ੍ਰੀਮ ਕਰੋ',
    'howItWorks.streamData.description': 'ਸੈਂਸਰ ਡੇਟਾ ਆਪਣੇ ਆਪ ਸੁਰੱਖਿਅਤ ਕਲਾਊਡ ਪਲੇਟਫਾਰਮ ਤੇ ਪ੍ਰੋਸੈਸਿੰਗ ਲਈ ਭੇਜਿਆ ਜਾਂਦਾ ਹੈ।',
    'howItWorks.mlRecommends.title': 'ML ਖੁਰਾਕ ਦੀ ਸਿਫਾਰਸ਼ ਕਰਦਾ ਹੈ',
    'howItWorks.mlRecommends.description': 'ਸਾਡਾ AI ਤੁਹਾਡੇ ਡੇਟਾ ਦਾ ਵਿਸ਼ਲੇਸ਼ਣ ਕਰਦਾ ਹੈ ਅਤੇ ਸ਼ੁੱਧ ਖਾਦ ਸਿਫਾਰਸ਼ਾਂ ਤਿਆਰ ਕਰਦਾ ਹੈ।',
